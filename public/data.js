...
const PROFILE_FIELDS = [
  ...
  { id: 'emigYear',  label: 'Year (or era) your family emigrated', example: '1956' },
  ...
  },
  {
    ...
    qa: [
      ...
      { script: '3.7', q: { hu: 'Beszél a családja magyarul?', en: 'Does your family speak Hungarian?', say: 'BEH-sayl aw CHAW-lahd-yaw MAW-dyaw-rool' },
        a: { hu: 'Egy kicsit. Otthon néha gyakorolunk magyarul.', en: 'A little. At home we sometimes practice Hungarian.', say: 'edy KEE-cheet. OTT-hon NAY-haw DYAW-ko-ro-loonk' } },
    ],
  },
  {
    id: 'szarmazas',
    ...
    qa: [
      ...
      { script: '4.5', q: { hu: 'Beszéltek otthon magyarul?', en: 'Did you speak Hungarian at home?', say: 'BEH-sayl-tek OTT-hon MAW-dyaw-rool' },
        a: { hu: 'Néha igen. ___ magyarul beszélt velem.', en: 'Sometimes, yes. ___ (your ancestor) spoke Hungarian with me.', say: 'NAY-haw EE-gen. ... MAW-dyaw-rool BEH-saylt VEH-lem', slot: 'ancestor' } },
