...
const TOPICS = [
  {
    ...
    qa: [
      ...
      { script: '1.5', q: { hu: 'Kérem az iratait.', en: 'Your documents, please.', say: 'KAY-rem awz EE-raw-taw-eet' },
  ...
  },
  {
    ...
    items: [
      ...
      { hu: '___-ban születtem.', en: 'I was born in ___ (year).', say: 'SEW-let-tem', slot: 'birthYear' },
    ...
    qa: [
      ...
      { script: '2.4', q: { hu: 'Hol lakik?', en: 'Where do you live?', say: 'hol LAW-keek' }, variants: ['Mi a lakcíme?'],
        a: { hu: '___ városában lakom.', en: 'I live in the town of ___.', say: 'VAH-ro-shah-bawn LAW-kom', slot: 'homeTown' } },
  ...
  },
  {
    ...
    items: [
      ...
      { hu: 'Nincs gyerekem.', en: 'I have no children.', say: 'neench DYEH-reh-kem' },
    ...
    qa: [
      ...
      { script: '3.3', q: { hu: 'Vannak gyerekei?', en: 'Do you have children?', say: 'VAWN-nawk DYEH-reh-keh-ee' }, variants: ['Hány gyereke van?'],
        a: { hu: '___.', en: 'Your own answer: how many children, if any.', say: 'DYEH-reh-kem', slot: 'kids' } },
      { script: '3.4', q: { hu: 'Hogy hívják a gyerekeit? Hány évesek?', en: 'What are your children’s names? How old are they?', say: 'hody HEEV-yahk aw DYEH-reh-keh-eet? hahny AY-veh-shek' },
        a: { hu: 'A gyerekeim: ___.', en: 'My children: ___ (names and ages).', say: 'aw DYEH-reh-keh-eem', slot: 'children' } },
      { script: '3.5', q: { hu: 'Élnek a szülei? Hol élnek?', en: 'Are your parents alive? Where do they live?', say: 'AYL-nek aw SEW-leh-ee? hol AYL-nek' },
        a: { hu: '___.', en: 'Your own answer: whether your parents are alive and where they live.', say: 'aw SEW-leh-eem', slot: 'parents' } },
      { script: '3.6', q: { hu: 'Vannak testvérei?', en: 'Do you have siblings?', say: 'VAWN-nawk TESHT-vay-reh-ee' },
        a: { hu: '___.', en: 'Your own answer: your siblings, if any.', say: 'TESHT-vay-rem', slot: 'siblings' } },
      { script: '3.7', q: { hu: 'Beszél a családja magyarul?', en: 'Does your family speak Hungarian?', say: 'BEH-sayl aw CHAW-lahd-yaw MAW-dyaw-rool' },
        a: { hu: '___.', en: 'Your own answer: does your family speak Hungarian.', say: 'edy KEE-cheet', slot: 'famHu' } },
    ],
  },
  {
    id: 'szarmazas',
    ...
    items: [
      ...
      { hu: 'A családom ___ városából származik.', en: 'My family comes from the town of ___.', say: 'aw CHAW-lah-dom ... VAH-ro-shah-bohl SAHR-maw-zeek', slot: 'ancestorTown' },
      { hu: 'A felmenőm neve ___ volt.', en: 'My ancestor’s name was ___.', say: 'aw FEL-meh-nurm NEH-veh ... volt', slot: 'ancestorName' },
      ...
      { hu: '___ sokat mesélt Magyarországról.', en: '___ (your ancestor) told many stories about Hungary.', say: 'SHO-kawt MEH-shaylt MAW-dyawr-or-sahg-rohl', slot: 'ancestor' },
    ...
    qa: [
      ...
      { script: '4.2', q: { hu: 'Hogy hívták a nagymamáját?', en: 'What was your grandmother’s name?', say: 'hody HEEV-tahk aw NAWDY-maw-mah-yaht' }, variants: ['Hogy hívták a nagypapáját?'],
        a: { hu: 'A felmenőm neve ___ volt.', en: 'My ancestor’s name was ___.', say: 'aw FEL-meh-nurm NEH-veh ... volt', slot: 'ancestorName' } },
  ...
  },
  {
    ...
    items: [
      ...
      { hu: 'Mindennap gyakorlok egy kicsit.', en: 'I practice a little every day.', say: 'MEEN-den-nawp DYAW-kor-lok edy KEE-cheet' },
    ],
    qa: [
      { script: '5.1', q: { hu: 'Meséljen egy kicsit magáról!', en: 'Tell me a little about yourself.', say: 'MEH-shayl-yen edy KEE-cheet MAW-gah-rohl' },
        a: { hu: '___', en: 'Your own 2–3 sentence self-introduction.', say: 'aw NEH-vem', slot: 'intro' } },
