...
const TOPICS = [
  {
    ...
    items: [
      ...
      { hu: 'Tudná ismételni?', en: 'Could you repeat that?', say: 'TOOD-nah EESH-may-tel-nee' },
      ...
      { hu: 'Sajnos nem tudom.', en: 'Unfortunately I don’t know.', say: 'SHOY-nosh nem TOO-dom' },
    ...
    qa: [
      ...
      { script: '7.3', q: { hu: 'Az eskü szövegét ismeri?', en: 'Do you know the text of the oath?', say: 'awz ESH-kew SUR-veh-gayt EESH-meh-ree' },
        a: { hu: 'Igen, tudom, hogy az eskü a ceremónián lesz.', en: 'Yes, I know the oath will be at the ceremony.', say: 'EE-gen, TOO-dom, hody awz ESH-kew aw TSEH-reh-moh-nee-ahn les' } },
    ],
  },
  {
    id: 'adatok',
    ...
    items: [
      ...
      { hu: '___-ban lakom.', en: 'I live in ___.', say: 'LAW-kom', slot: 'homeTown' },
      ...
      { hu: 'negyvenkét éves vagyok', en: 'I am forty-two years old', say: 'NEDY-ven-kayt AY-vesh VAW-dyok' },
      ...
      { hu: 'ezerkilencszáz-nyolcvanöt', en: 'nineteen eighty-five (year)', say: 'EH-zer-KEE-lents-sahz NYOLTS-vawn-urt' },
    ...
    qa: [
      ...
      { script: '2.3', q: { hu: 'Hol született?', en: 'Where were you born?', say: 'hol SEW-leh-tett' },
        a: { hu: '___-ban születtem, de most máshol élek.', en: 'I was born in ___, but I live elsewhere now.', say: 'SEW-let-tem, deh mosht MAHSH-hol AY-lek', slot: 'birthPlace' } },
      { script: '2.4', q: { hu: 'Hol lakik?', en: 'Where do you live?', say: 'hol LAW-keek' }, variants: ['Mi a lakcíme?'],
        a: { hu: '___-ban lakom, a családommal.', en: 'I live in ___, with my family.', say: 'LAW-kom, aw CHAW-lah-dom-mawl', slot: 'homeTown' } },
      ...
      { script: '2.7', q: { hu: 'Hány éves?', en: 'How old are you?', say: 'hahny AY-vesh' },
        a: { hu: 'Negyvenkét éves vagyok.', en: 'I am forty-two years old. (swap in your number)', say: 'NEDY-ven-kayt AY-vesh VAW-dyok' } },
    ],
  },
  {
    id: 'csalad',
    ...
    items: [
      ...
      { hu: 'A szüleim ___-ban élnek.', en: 'My parents live in ___.', say: 'aw SEW-leh-eem ... AYL-nek', slot: 'birthPlace' },
      ...
      { hu: 'Sajnos édesanyám már nem él.', en: 'Sadly my mother is no longer alive.', say: 'SHOY-nosh AY-desh-aw-nyahm mahr nem ayl' },
      { hu: 'Nőtlen vagyok. / Hajadon vagyok.', en: 'I am single. (man / woman)', say: 'NURT-len VAW-dyok / HAW-yaw-don VAW-dyok' },
    ],
    qa: [
      { script: '3.1', q: { hu: 'Nős?', en: 'Are you married? (to a man)', say: 'nursh' }, variants: ['Férjnél van?'],
        a: { hu: 'Igen, nős vagyok. / Igen, férjnél vagyok.', en: 'Yes, I’m married. (m/f)', say: 'EE-gen, nursh VAW-dyok' } },
      { script: '3.2', q: { hu: 'Mi a házastársa neve?', en: 'What is your spouse’s name?', say: 'mee aw HAH-zawsh-tahr-shaw NEH-veh' },
        a: { hu: 'A feleségem neve Anna. / A férjem neve Péter.', en: 'My wife’s name is Anna. / My husband’s name is Péter.', say: 'aw FEH-leh-shay-gem NEH-veh AWN-naw' } },
      ...
      { script: '3.4', q: { hu: 'Hogy hívják a gyerekeit? Hány évesek?', en: 'What are your children’s names? How old are they?', say: 'hody HEEV-yahk aw DYEH-reh-keh-eet? hahny AY-veh-shek' },
        a: { hu: 'A fiam Tamás, tízéves. A lányom Emma, nyolcéves.', en: 'My son is Tamás, ten years old. My daughter is Emma, eight.', say: 'aw FEE-awm TAW-mahsh, TEEZ-ay-vesh' } },
      { script: '3.5', q: { hu: 'Élnek a szülei? Hol élnek?', en: 'Are your parents alive? Where do they live?', say: 'AYL-nek aw SEW-leh-ee? hol AYL-nek' },
        a: { hu: 'Igen, a szüleim ___-ban élnek.', en: 'Yes, my parents live in ___.', say: 'EE-gen, aw SEW-leh-eem ... AYL-nek', slot: 'birthPlace' } },
  ...
  },
  {
    ...
    items: [
      ...
      { hu: 'A nagymamám ___-ból származik.', en: 'My grandmother comes from ___.', say: 'aw NAWDY-maw-mahm ... SAHR-maw-zeek', slot: 'ancestorTown' },
      { hu: 'A nagymamámat Kovács Erzsébetnek hívták.', en: 'My grandmother was called Erzsébet Kovács.', say: 'aw NAWDY-maw-mah-mawt KO-vahch ER-zhay-bet-nek HEEV-tahk' },
    ...
    qa: [
      ...
      { script: '4.2', q: { hu: 'Hogy hívták a nagymamáját?', en: 'What was your grandmother’s name?', say: 'hody HEEV-tahk aw NAWDY-maw-mah-yaht' }, variants: ['Hogy hívták a nagypapáját?'],
        a: { hu: 'A nagymamámat Kovács Erzsébetnek hívták.', en: 'My grandmother was called Erzsébet Kovács. (swap in the real name)', say: 'aw NAWDY-maw-mah-mawt KO-vahch ER-zhay-bet-nek HEEV-tahk' } },
      { script: '4.3', q: { hu: 'Hol született a nagymamája?', en: 'Where was your grandmother born?', say: 'hol SEW-leh-tett aw NAWDY-maw-mah-yaw' }, variants: ['Melyik városban?'],
        a: { hu: 'A nagymamám ___-ból származik.', en: 'My grandmother comes from ___.', say: 'SAHR-maw-zeek', slot: 'ancestorTown' } },
  ...
  },
  {
    ...
    items: [
      ...
      { hu: 'tanárral és egy applikációval', en: 'with a teacher and an app', say: 'TAW-nahr-rawl aysh edy AWP-lee-kah-tsee-oh-vawl' },
    ...
    qa: [
      { script: '5.1', q: { hu: 'Meséljen egy kicsit magáról!', en: 'Tell me a little about yourself.', say: 'MEH-shayl-yen edy KEE-cheet MAW-gah-rohl' },
        a: { hu: 'A nevem ___, ___-ban lakom, és ___ vagyok. A családommal élek.', en: 'My name is ___, I live in ___, and I am a ___. I live with my family.', say: 'aw NEH-vem', slot: 'name' } },
      ...
      { script: '5.5', q: { hu: 'Hogyan tanult magyarul?', en: 'How did you learn Hungarian?', say: 'HO-dyawn TAW-noolt MAW-dyaw-rool' },
        a: { hu: 'Tanárral és egy applikációval tanulok. Minden nap gyakorlok.', en: 'I learn with a teacher and an app. I practice every day.', say: 'TAW-nahr-rawl aysh edy AWP-lee-kah-tsee-oh-vawl' } },
      { script: '5.6', q: { hu: 'Szereti a magyar ételeket?', en: 'Do you like Hungarian food?', say: 'SEH-reh-tee aw MAW-dyawr AY-teh-leh-ket' }, variants: ['Mit szeret főzni?'],
        a: { hu: 'Igen, nagyon! Szeretem a gulyáslevest és a lángost.', en: 'Yes, very much! I love goulash soup and lángos.', say: 'EE-gen, NAW-dyon' } },
    ],
  },
  {
    id: 'magyarorszag',
    ...
    qa: [
      ...
      { script: '6.4', q: { hu: 'Tartja a kapcsolatot magyarországi rokonokkal?', en: 'Are you in touch with relatives in Hungary?', say: 'TAWRT-yaw aw KAWP-cho-law-tot MAW-dyawr-or-sah-gee RO-ko-nok-kawl' },
      ...
      { script: '6.5', q: { hu: 'Milyen magyar ünnepeket ismer?', en: 'What Hungarian holidays do you know?', say: 'MEE-yen MAW-dyawr EWN-neh-peh-ket EESH-mer' }, variants: ['Hogyan ünnepelnek?'],
        a: { hu: 'Ismerem március tizenötödikét és augusztus huszadikát, Szent István ünnepét.', en: 'I know March 15 and August 20, the feast of Saint Stephen.', say: 'EESH-meh-rem MAHR-tsee-oosht' } },
      ...
      { script: '6.7', q: { hu: 'Mikor van a magyar nemzeti ünnep?', en: 'When are the Hungarian national holidays?', say: 'MEE-kor vawn aw MAW-dyawr NEM-zeh-tee EWN-nep' },
